...
map <- leaflet() %>%
    ...
    addCircleMarkers(data = df2, ~Longitude, ~Latitude, popup = ~paste("<b>",LocationTitle,"</b><br>","<b>Connection Type:</b> ",ConnectionType,"<br>","<b>Number of Points:</b> ",NumberOfPoints,"<br>","<b>Status:</b> ",StatusType, "<br><b>Reserve: </b>Enroute (",runif(1,min=5,max=60),")","<br> 10:00AM, 11:00AM, 12:00PM, 1:00PM, 2:00PM, 3:00PM, 4:00PM, 5:00PM"), clusterOptions = markerClusterOptions(),
        color = "navy", group = "Public", fillOpacity = 0.5, stroke = FALSE) %>%
    addCircleMarkers(data = df3, ~Longitude, ~Latitude, popup = ~paste("<b>",LocationTitle,"</b><br>","<b>Connection Type:</b> ",ConnectionType,"<br>","<b>Number of Points:</b> ",NumberOfPoints,"<br>","<b>Status:</b> ",StatusType, "<br><b>Reserve: </b>Enroute (",runif(1,min=5,max=60),")","<br> 10:00AM, 11:00AM, 12:00PM, 1:00PM, 2:00PM, 3:00PM, 4:00PM, 5:00PM"), clusterOptions = markerClusterOptions(),
